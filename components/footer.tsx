          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                Get updates on our{" "}
                <span className="text-orange-400/80">latest products</span> and
                services.
              </p>
              {joined ? (
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-600 font-mono">
            © 2026 <span className="text-gray-500">TroyTech Solutions</span> ·
            All rights reserved.
          </p>
          ...
          <p className="text-xs text-gray-600 font-mono">
            Built with{" "}
            <span className="text-orange-500/70 hover:text-orange-400 transition-colors cursor-default">
              Next.js
            </span>{" "}
            ·{" "}
            <span className="text-orange-500/70 hover:text-orange-400 transition-colors cursor-default">
