      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 min-h-screen">
          ...
          <div className="flex flex-col justify-center py-24 lg:py-32">
            ...
            {/* Sub-headline */}
            <p className="mt-6 text-lg text-orange-300/80 font-mono max-w-lg leading-relaxed tracking-wide animate-fade-in-up delay-200">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-xl px-7 py-3.5 text-sm font-mono font-semibold text-black bg-[#F97316] shadow-[0_0_20px_rgba(249,115,22,0.45)] hover:brightness-110 hover:scale-[1.03] hover:shadow-[0_0_36px_rgba(249,115,22,0.65)] active:scale-[0.98] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#F97316] focus:ring-offset-2 focus:ring-offset-black"
              >
                Get Started Free
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-xl px-7 py-3.5 text-sm font-mono font-semibold text-white bg-transparent border border-orange-500/50 hover:border-orange-400 hover:shadow-[0_0_20px_rgba(249,115,22,0.3)] hover:scale-[1.03] active:scale-[0.98] transition-all duration-200"
              >
                Talk to TroyTech
                <ArrowRightIcon className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-1" />
              </a>
          ...
          <div className="relative flex items-center justify-center py-16 lg:py-0">
            ...
            <div className="relative z-10 w-full max-w-lg xl:max-w-xl animate-float-slow">
              ...
              {/* Floating stats card */}
              <div
                className="absolute -bottom-5 -right-4 sm:right-4 bg-[#1a1a1a]/95 backdrop-blur-md border border-orange-800/40 rounded-xl shadow-[0_0_30px_rgba(249,115,22,0.12)] p-4 flex items-center gap-4 animate-float hover:shadow-[0_0_40px_rgba(249,115,22,0.25)] hover:-translate-y-1 transition-all duration-300"
              ...
              <div
                className="absolute -top-4 -left-4 sm:left-4 bg-[#1a1a1a]/95 backdrop-blur-md border border-orange-800/40 rounded-xl shadow-[0_0_20px_rgba(249,115,22,0.10)] px-4 py-2.5 flex items-center gap-2 animate-float-xs hover:shadow-[0_0_28px_rgba(249,115,22,0.25)] hover:-translate-y-1 transition-all duration-300"
