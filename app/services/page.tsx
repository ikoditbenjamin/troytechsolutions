...
export const metadata: Metadata = {
  title: "IT Services in Uganda | TroyTech Solutions — Kampala",
  description:
    "TroyTech Solutions provides IT security, software development, graphics design, computer training, printing, CCTV installation, and loan services in Uganda.",
  keywords: [
    "IT services Uganda",
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "TroyTech Solutions Services" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
